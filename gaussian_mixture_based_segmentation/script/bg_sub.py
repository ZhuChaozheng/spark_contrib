...
## [capture]
capture = cv.VideoCapture('/home/spark/spark/src/spark_app/gaussian_mixture_based_segmentation/data/vtest.avi')
...
## [create]
## [background picture]
img_bg = cv.imread('/home/spark/spark/src/spark_app/gaussian_mixture_based_segmentation/data/fruits.jpg')
...
while True:
    ...
    ## [resize background]
    fx = source_size[1] * 1.0 / img_bg_size[1]
    fy = source_size[0] * 1.0 / img_bg_size[0]
